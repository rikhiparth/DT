  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
         ...
         <li><a href="${pageContext.request.contextPath}/user/userabout">ABOUT US</a></li>
         <li><a href="${pageContext.request.contextPath}/user/userproductgrid">PRODUCT GRID</a></li>        
         <li><a href="${pageContext.request.contextPath}/user/usergetAllproducts">PRODUCT LIST</a></li>
      </ul>
      
      <ul class="nav navbar-nav navbar-right">
      <li><a href="${pageContext.request.contextPath}/user/createcart">ADD CART</a></li>
      <li><a href="${pageContext.request.contextPath}/user/getcartItems">CART</a></li>
